...
ChannelJoin.create({user_id: 3, channel_id: 1})
ChannelJoin.create({user_id: 3, channel_id: 2})
ChannelJoin.create({user_id: 4, channel_id: 1})
ChannelJoin.create({user_id: 4, channel_id: 2})
ChannelJoin.create({user_id: 5, channel_id: 1})
ChannelJoin.create({user_id: 5, channel_id: 2})
